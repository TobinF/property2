...
def trans_func():
    ...
    udata_storage(p[0],D_t[0],'Pressure-Density\\Data\\transfer_superheat_data.json')
    ...
    # plt.plot(p,Cp_u)
    # plt.show()
    udata_storage(p_u,D_u,'Pressure-Density\\Data\\superheat_fitting_nodes.json')
...
def coefficient_storage(popt_D):
    ...
    with open('Pressure-Density\\Data\\D0_superheat_coefficient.json','w',encoding='utf-8') as f:       
            f.write(json_data)
    pass
